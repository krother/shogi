...
Piece = Literal["chick", "lion", "elephant", "giraffe", "chicken", ""]
Player = int|None
Field = list[list[tuple[Piece, Player]]]
...
def execute_move(field: Field, player: Player, move: Move) -> tuple[Field, Player, str|None]:
    ...
    if valid:
        ...
        if field[end_y][end_x][0] == "chick" and end_y in (0, 3):
            ...
            # TODO: find better type representation
